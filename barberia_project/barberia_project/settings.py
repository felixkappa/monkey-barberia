...
SECRET_KEY = "django-insecure-)+#0dnso$=b0p$cqhya%pc73ata)kx5x#o993=fw2x9864yk^a"
...
SITE_ID = 1 # 👈 Django necesita saber el ID del sitio

# Configuración específica de allauth
